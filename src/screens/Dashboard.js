        ...
        <LinearGradient
          ...
          <View
            ...
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text
                style={{textAlign: 'center', color: '#ffffff', fontSize: 22}}>
                Campus Doctor
              </Text>
            </View>
          </View>
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <DashboardViews
                  imageUri={require('../assests/doctor.png')}
              ...
              <TouchableOpacity
                ...
                <DashboardViews
                  imageUri={require('../assests/appointment.png')}
                    ...
                    <ScrollView>
                      <View style={{marginHorizontal: 10}}>
                        ...
                        <Picker
                          ...
                          />
                          <Picker.Item
                            label="SEXUAL HEALTH DOCTOR"
                            value="Sexual Health Doctor"
                          />
                        </Picker>
                      </View>
                    </ScrollView>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Dose')}
                style={{
                  flex: 1,
                  justifyContent: 'space-between',
                  alignItems: 'center',
                ...
                <DashboardViews
                  imageUri={require('../assests/medicine.png')}
                  label="Dosage Reminder"
                />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <DashboardViews
                  imageUri={require('../assests/compress.png')}
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <DashboardViews
                  imageUri={require('../assests/network.png')}
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Linking.openURL('https://www.thecampusdoctor.com')
                }>
                <DashboardViews
                  imageUri={require('../assests/more.png')}
                  label="More"
                />
              </TouchableOpacity>
            </View>
