...
export default class EditPeriod extends Component {
  ...
  _storeData = async () => {
    ...
    for (var i = 0; i < this.state.numofperiod; i++) {
      var periodarray = moment(this.state.perioddate)
        .add(1, this.state.perioddate)
        .format('YYYY-MM-D');
          ...
          <View style={{height: 56, flexDirection: 'row'}}>
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <TouchableOpacity
                ...
                <Icon
                  name="arrow-back"
                  style={{paddingLeft: 15, paddingRight: 45, color: '#ffffff'}}
                  size={30}
                />
              </TouchableOpacity>
            </View>
            ...
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text
                style={{textAlign: 'center', color: '#ffffff', fontSize: 20}}>
                Preferences
              </Text>
            </View>
          </View>
            ...
            <KeyboardAvoidingView
              ...
              <View style={{marginHorizontal: 10}}>
                ...
                <DatePicker
                  ...
                  onDateChange={perioddate => {
                    this.setState({perioddate: perioddate});
                  }}
                />
                <Text
                  style={{
                ...
                <TextInput
                  onChangeText={numofperiod => this.setState({numofperiod})}
                  returnKeyType="next"
                  placeholder="4"
                ...
                <TextInput
                  onChangeText={lengthofperiod =>
                    this.setState({lengthofperiod})
                  }
                  returnKeyType="done"
                  placeholder="21"
                  keyboardType="numeric"
              ...
              <View
                ...
                <View
                  style={{justifyContent: 'flex-start', marginHorizontal: 15}}>
                  <TouchableOpacity
                ...
                <View
                  style={{justifyContent: 'flex-end', marginHorizontal: 15}}>
                  <TouchableOpacity
                    onPress={() => {
                      this.props.navigation.navigate('BottomNavigator');
                    }}
